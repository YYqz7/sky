...
public class OrdersServiceImpl implements OrdersService {
    ...
    public void complete(Long id) {
        // 根据id查询订单
        OrderHistoryVO ordersDB = ordersMapper.selectByOrderID(id);
    ...
    public void cancel(OrdersCancelDTO ordersCancelDTO) throws Exception {
        // 根据id查询订单
        OrderHistoryVO ordersDB = ordersMapper.selectByOrderID(ordersCancelDTO.getId());
    ...
    public void rejection(OrdersRejectionDTO ordersRejectionDTO) throws Exception {
        // 根据id查询订单
        OrderHistoryVO ordersDB = ordersMapper.selectByOrderID(ordersRejectionDTO.getId());
...
//            log.info("申请退款：{}", refund);
    ...
    public OrderVO details(Long id) {
        // 根据id查询订单
        OrderHistoryVO orders = ordersMapper.selectByOrderID(id);
    ...
    public OrderSubmitVO userPlacesOrder(OrdersSubmitDTO dto) {
        ...
        checkOutOfRange(adrBook.getCityName() + adrBook.getDistrictName() + adrBook.getDetail());
